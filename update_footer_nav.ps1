...
foreach ($file in $htmlFiles) {
    ...
    # 3. Remove designed by and distributed by 
    # This regex looks for the comment block followed by "Designed By" up through "ThemeWagon</a>"
    $regexFooter = '(?s)<!--/\*\*\*.*?\*\*\*/-->\s*Designed By.*?ThemeWagon</a>'
    $content = [System.Text.RegularExpressions.Regex]::Replace($content, $regexFooter, "")

    [System.IO.File]::WriteAllText($file.FullName, $content, [System.Text.Encoding]::UTF8)
}
Write-Output "Successfully updated navbars and removed footers."
