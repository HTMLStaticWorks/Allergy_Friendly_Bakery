$nav_replacement = @"
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto p-4 p-lg-0">
                ...
                <a href="index2.html" class="nav-item nav-link">Home 2</a>
            ...
            <div class="d-flex align-items-center ms-lg-3">
                ...
                <button id="rtlToggle" class="btn btn-sm btn-outline-light rounded-circle border-light me-2 mt-3 mt-lg-0" title="Toggle RTL" style="width: 32px; height: 32px; padding: 0; display: flex; align-items: center; justify-content: center;">
                    <span id="rtlText" style="font-size: 10px; font-weight: bold;">RTL</span>
                </button>
                <button id="themeToggle" class="btn btn-sm btn-outline-light rounded-circle border-light mt-3 mt-lg-0" title="Toggle theme" style="width: 32px; height: 32px; padding: 0; display: flex; align-items: center; justify-content: center;">
...
foreach ($file in $htmlFiles) {
    ...
    if ($basename -in @('team.html', 'testimonial.html', '404.html')) {
        $content = $content -replace 'class="nav-link dropdown-toggle"', 'class="nav-link dropdown-toggle active"'
    }

    [System.IO.File]::WriteAllText($file.FullName, $content, [System.Text.Encoding]::UTF8)
}
Write-Output "Successfully updated navbars to have Home 2 as a top-level link and Login as button."
